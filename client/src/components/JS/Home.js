    ...
    <div>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <div className={cls.navBar}>
              <Nav className="mr-auto">
                ...
                <Nav.Item className={cls.navItem}>
                  <Link className={cls.link} to="/rent">
                    Rent
                  </Link>
                </Nav.Item>
      ...
      <div className="container d-lg-flex">
        ...
        <div className="col-lg-5 header-title-section text-center text-lg-left mx-lg-auto align-items-lg-start">
          ...
          <p className={cls.headerTitleTest}>
            Booking in the easiest way, it is very convenient and accordant for
            everyone with a few simple steps
          </p>
        </div>
      </div>
        ...
        <div className="container strategy-section d-md-flex flex-wrap">
            ...
            <div className={clsB.strategyCard}>
              <div className="strategy-card-icon">
                <img
                  ...
                  className={clsB.imgBody}
                  width={95}
                ></img>
              </div>
              <h2 className={clsB.titleStrategy + " my-3"}>Booking</h2>
          ...
          <div className="stragegy-card-section my-5 col-md-6 col-lg-3">
            <div className={clsB.strategyCard}>
              ...
              <h2 className={clsB.titleStrategy + " my-3"}>Verified</h2>
              <p className={clsB.subTitleStrategy}>
          ...
          <div className="stragegy-card-section my-5 col-md-6 col-lg-3">
            <div className={clsB.strategyCard}>
              ...
              <h2 className={clsB.titleStrategy + " my-3"}>Deposit</h2>
              <p className={clsB.subTitleStrategy}>
          ...
          <div className="stragegy-card-section my-5 col-md-6 col-lg-3">
            <div className={clsB.strategyCard}>
              ...
              <h2 className={clsB.titleStrategy + " my-3"}>Remind</h2>
              <p className={clsB.subTitleStrategy}>
